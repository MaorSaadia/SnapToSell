...
export default function SettingsPage() {
  ...
  // Mock subscription data since we're having database connection issues
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-2">
              ...
              <div className="text-2xl font-bold">{mockSubscription.tier}</div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-2 hover:border-primary hover:shadow-md transition-all">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    variant={
                      mockSubscription.tier === "Free" ? "outline" : "default"
                    }
                    className="w-full"
                    disabled={mockSubscription.tier === "Free"}
                  >
              ...
              <Card className="border-2 border-primary shadow-md">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    variant={
                      mockSubscription.tier === "Professional"
                        ? "outline"
                        : "default"
                    }
                    className="w-full"
                    disabled={mockSubscription.tier === "Professional"}
                  >
                    {mockSubscription.tier === "Professional"
                      ? "Current Plan"
                      : "Select Plan"}
              ...
              <Card className="border-2 hover:border-primary hover:shadow-md transition-all">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full"
                    disabled={mockSubscription.tier === "Business"}
                  >
                    {mockSubscription.tier === "Business"
                      ? "Current Plan"
                      : "Select Plan"}
