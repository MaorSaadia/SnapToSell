      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-8 md:py-12 sm:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent>
              <div className="flex h-[140px] sm:h-[180px] items-center justify-center rounded-md border border-dashed p-4">
                <div className="space-y-2 text-center">
                  <svg
                    ...
                    className="h-8 w-8 sm:h-10 sm:w-10 mx-auto text-gray-500"
                  >
